...
const META: Record<SidebarSection, { icon: string; title: string; desc: string }> = {
  ...
  banka:            { icon: 'solar:wallet-bold-duotone',              title: 'Bankovní účty',   desc: 'Bankovní účty a transakce' },
  'trvale-prikazy': { icon: 'solar:refresh-circle-bold-duotone',      title: 'Trvalé příkazy',  desc: 'Evidence trvalých příkazů a leasingových splátek' },
  uvery:            { icon: 'solar:hand-money-bold-duotone',          title: 'Úvěry',           desc: 'Evidence úvěrů (jistina, úrok, splátkový kalendář)' },
  poplatky:         { icon: 'solar:tag-price-bold-duotone',           title: 'Poplatky',        desc: 'Bankovní poplatky jako celofiremní náklad' },
  karty:            { icon: 'solar:card-bold-duotone',                title: 'Platební karty',  desc: 'Souhrnný přehled plateb přes karty (terminály)' },
  qerko:            { icon: 'solar:qr-code-bold-duotone',             title: 'Qerko',           desc: 'Mobilní platby QR — příchozí platby a poplatky' },
  gopay:            { icon: 'solar:card-2-bold-duotone',              title: 'GoPay',           desc: 'Online platební brána — příchozí platby a poplatky' },
  sodexo:           { icon: 'solar:ticket-bold-duotone',              title: 'Sodexo',          desc: 'Stravenkové platby — manuální import, poplatky' },
